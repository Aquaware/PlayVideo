...
QT_MOC_LITERAL(1, 10, 11), // "selectVideo"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "playVideo\0selectVideo\0"
};
...
void playVideo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        playVideo *_t = static_cast<playVideo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectVideo(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject playVideo::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_playVideo.data,
      qt_meta_data_playVideo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *playVideo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_playVideo.stringdata0))
        return static_cast<void*>(const_cast< playVideo*>(this));
